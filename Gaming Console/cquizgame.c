...
int main()
     ...
     if (choice=='V')                                                       //get the character user input, and accordingly do the operation.
	{
	show_record();
	goto mainhome;
	}
    ...
    system("cls");
    printf("\n ------------------  Welcome %s to C Program Quiz Game --------------------------",playername);    //displaying the rules to the user.
    ...
    printf("\n >> Once you give a wrong answer, your quiz game will end at that very moment.");
    printf("\n\n\t!!!!!!!!!!!!! ALL THE BEST !!!!!!!!!!!!!");
    ...
    system("cls");
     ...
     switch(r1)
		{
		case 1:
		printf("\n\nWhich of the following is a Palindrome number?");                  //display the question and options
		printf("\n\nA.42042\t\tB.101010\n\nC.23232\t\tD.01234");
		if (toupper(getch())=='C')
			{
			    printf("\n\nCorrect!!!");count++;                                      //display correct if correct answer is given
			    getch();
			    break;
}
		else
		       {
		           printf("\n\nWrong!!! The correct answer is C.23232");              //display correct answer if incorrect is given.
		           getch();
		       break;
		       }
...
game:
     ...
     switch(r)
		...
		case 21:
		printf("\n\n\nOzone Layer is being destroyed regularly because of____ ?");
		printf("\n\nA.L.P.G\t\tB.Nitrogen\n\nC.Methane\t\tD. C.F.C");
		if (toupper(getch())=='D')
			{printf("\n\nCorrect!!!");countr++; getch();
			break;}
		...
		case 23:
		printf("\n\n\nWhich film was awarded the Best Motion Picture at The Oscars Ceremony in 2010?");
...
void help()                                                                                   //displaying help rules in help option
	{system("cls");
    printf("\n\n                              HELP");
    printf("\n -------------------------------------------------------------------------");
    printf("\n ......................... C program Quiz Game...........");
